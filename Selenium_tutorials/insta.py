...
class InstaBot:
    def __init__(self, username, pw):
        ...
        self.driver.find_element_by_xpath("/html/body/div[1]/section/main/div/article/div/div[1]/div/form/div[3]/div/label/input")\
            .send_keys(pw)
        self.driver.find_element_by_xpath('/html/body/div[1]/section/main/div/article/div/div[1]/div/form/div[4]/button/div')\
            .click()
        sleep(4)
...
my_bot = InstaBot('azhad.ghufran', 'Dabkdi@126814')
